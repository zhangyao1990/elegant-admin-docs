import{_ as s,k as a,F as n,W as l}from"./chunks/framework.56f03db6.js";const g=JSON.parse('{"title":"目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"guide/catalogue.md","filePath":"guide/catalogue.md","lastUpdated":null}'),e={name:"guide/catalogue.md"},p=l(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h1><h2 id="elegant-admin-目录说明-📚" tabindex="-1">Elegant-Admin 目录说明 📚 <a class="header-anchor" href="#elegant-admin-目录说明-📚" aria-label="Permalink to &quot;Elegant-Admin 目录说明 📚&quot;">​</a></h2><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#babed8;">├── node_modules  # 模块依赖</span></span>
